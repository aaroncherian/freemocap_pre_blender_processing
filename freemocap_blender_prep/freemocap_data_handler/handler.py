...
import numpy as np
from freemocap_blender_prep.core_functions.empties.creation.create_virtual_trajectories import \
    calculate_virtual_trajectories
from freemocap_blender_prep.data_models.freemocap_data.freemocap_data_model import FreemocapData, \
    FREEMOCAP_DATA_COMPONENT_TYPES
from freemocap_blender_prep.data_models.freemocap_data.helpers.freemocap_component_data import \
